if (typeof window.Auger === 'undefined') {
  ...
  Auger.Init = function (callback) {
    ...
    function _loadDependencies(innerCallback) {
      if (typeof jQuery === 'undefined') {
        Auger.LoadScript(Auger._scriptUrlBase + 'jquery.js', function () {
          _loadDependencies(innerCallback);
        });
        return;
      }
      if (typeof Mocha === 'undefined') {
        Auger.LoadScript(Auger._scriptUrlBase + "mocha.js", function () {
          _loadDependencies(innerCallback);
        });
        return;
      }
      if (typeof chai === 'undefined') {
        Auger.LoadScript(Auger._scriptUrlBase + "chai.js", function () {
          Auger.LoadScript(Auger._scriptUrlBase + "chai-jquery.js", function () {
            _loadDependencies(innerCallback);
          });
        });
        return;
      }
      // DEPRECATED: Old Interactive GUI
      if (Auger._gui) {
        if (typeof $.fn.modal === 'undefined') {
          Auger.LoadScript(Auger._scriptUrlBase + 'bootstrap.min.js', function () {
            _loadDependencies(innerCallback);
          });
          return;
        }
        if (typeof URI === 'undefined') {
          Auger.LoadScript(Auger._scriptUrlBase + 'URI.js', function () {
            _loadDependencies(innerCallback);
          });
          return;
        }
  ...
  // DEPRECATED: Old Interactive GUI Stuff
  if (Auger._gui) {
